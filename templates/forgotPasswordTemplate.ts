export const ForgotPasswordTemplate = ({
  ...
  return `<div>
    ...
    <p>Voici le lien de reinitialisation de votre mot de passe : <a href="http://localhost:3000/api/auth/reset-password?token=${token}">http://localhost:3000/api/auth/reset-password?token=${token}</a></p>
